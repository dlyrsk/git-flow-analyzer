...
def run_analyzer():
    event_log_raw = pandas.read_csv("data/git_event_matrix_04.csv")
    event_log_raw["case:concept:name"] = event_log_raw["repository_owner"] + event_log_raw["repository_owner"]      # case id
